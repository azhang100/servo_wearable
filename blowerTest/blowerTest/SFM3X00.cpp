/*
 * edited by: andrewzhang100@gmail.com
 * source: https://github.com/PubInv/SFM3X00
 * 
 * =====================================================================================
 *       Filename:  SFM3X00.cpp
...
{
  //DBSERIAL.println();
  //DBSERIAL.println(command, HEX);
  uint8_t b1 = (command & 0xFF00) >> 8;
  //DBSERIAL.println(b1, HEX);
  uint8_t b0 = command & 0x00FF;
  //DBSERIAL.println(b0, HEX);
...
uint16_t SFM3X00::readData()
{
  ...
  //DBSERIAL.println(c, HEX);
  //DBSERIAL.println(c, DEC);
